...
<div class="flex items-center justify-center h-full font-mono p-4">
  <div class="flex flex-col gap-8 items-center">
    ...
    <div class="flex items-center gap-8">
      <div class="tooltip tooltip-bottom pb-2" data-tip="Github Profile">
        <a
          aria-label="Github Profile"
          href="https://github.com/tyler-johnson"
          title="Github Profile"
        >
          <i class="fa-brands fa-github fa-2xl fa-fw"></i>
        </a>
      </div>
      <div class="tooltip tooltip-bottom pb-2" data-tip="Personal Email">
        <a aria-label="Personal Email" href="mailto:tyler@tylerjohnson.me" title="Personal Email">
          <i class="fa-solid fa-at fa-2xl fa-fw"></i>
        </a>
      </div>
    </div>
  </div>
